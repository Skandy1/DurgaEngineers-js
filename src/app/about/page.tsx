...
const page = () => {
  ...
  <div className="container px-5 py-10 mx-auto">
    <div className="flex flex-col text-center w-full mb-20">
      ...
      <p className="lg:w-2/3 mx-auto leading-relaxed text-base">We are a team of highly experienced and motivated professionals in the fire fighting and security equipment industry. We are passionate about customer care and satisfaction, our blend of quality and economy has been the reason for our success and the trust that our clients have bestowed in us.</p>
    </div>
    <div className="flex flex-wrap -m-4 text-center">
      <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
        <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
          ...
          <p className="leading-relaxed">Turn Key Solutions</p>
        </div>
      </div>
      <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
        <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
      ...
      <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
        <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
          ...
          <h2 className="title-font font-medium text-3xl text-gray-900">20+</h2>
          <p className="leading-relaxed">Rescues</p>
        </div>
      </div>
      <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
        <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
          ...
          <h2 className="title-font font-medium text-3xl text-gray-900">10 min</h2>
          <p className="leading-relaxed">Least Rescue Time</p>
        </div>
      </div>
    </div>
  </div>
...
<div className="flex flex-col text-center w-full mb-10 mt-4">
  ...
  <div className="container mx-auto flex px-5 md:flex-row flex-col items-center">
    ...
    <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
      ...
      <p className="mb-8 leading-relaxed text-justify">He comes with a decade of experience in the firefighting industry, having worked in Qatar and Saudi Arabia as a project manager in operations for Armour Fire Fighting Company LLC. Co. and Arab Projects for Safety Co. Ltd.
        <br/>
        <br/>
